...
@Component({
  selector: 'app-form-admission',
  templateUrl: './form-admission.component.html',
  styleUrls: ['./form-admission.component.css']
})
export class FormAdmissionComponent implements OnInit {
