...
export class AdmissionService {
  ...
  addIsncription(inscription : Inscription) : Observable<Inscription>{
    return this.http.post<Inscription>(this.URL+"/addInscription",inscription);
  }
  ...
  addInscription(inscription : Inscription): Observable<Inscription[]>{
    return this.http.post<Inscription[]>(this.URL+"/getAllOfferJob",inscription);
  }

  newAdmission(inscription : Inscription,id : number){
    return this.http.post(this.URL+"/addInscriptionWithUserAndAssignOffer/"+ id,inscription);
  } 
